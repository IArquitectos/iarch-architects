      ...
      <div className="container-edit py-20 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <div className="flex gap-4 mt-8">
            ...
            <a href="https://www.instagram.com/grupoinmobiliariomx/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2.5 border border-[var(--lino)]/20 hover:bg-[var(--terracota)] hover:border-[var(--terracota)] transition-colors duration-500">
              <Instagram size={16} />
            </a>
          </div>
        </div>
